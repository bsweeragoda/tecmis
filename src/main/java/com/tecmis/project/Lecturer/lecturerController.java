...
public ObservableList<coursematerialscontroller>courseMaterialsDetails() {
    ...
    public void addLecMaterialX() {
        String insertData = "INSERT INTO course_materials (material_name, course_material) VALUES (?, ?)";
        ...
        try {
            ...
            if (Material_Name.getText().isEmpty()) {
                ...
                prepare.setString(2, chosenFilePath);

                String checkData = "SELECT material_name FROM course_materials WHERE material_name = ?";
                prepareCheck = connect.prepareStatement(checkData);
...
//----------------------------------------------------------------------------------------------------------------------------------------------
    //Student Details
        ...
        public ObservableList<Controller> addController(){
            ...
            String sql = "SELECT user_id, Subject_id, State, Date FROM attendance ORDER BY user_id";
